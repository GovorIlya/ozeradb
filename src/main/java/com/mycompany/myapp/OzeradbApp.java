...
public class OzeradbApp {

    private static final Logger log = LoggerFactory.getLogger(OzeradbApp.class);

    private final Environment env;

    public OzeradbApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(OzeradbApp.class);
